...
import { completeProfile, type OnboardActionState } from '@/actions/onboard'
...
export default function OnboardProfileForm() {
	...
	const handleAction = (prev: OnboardActionState, formData: FormData) => {
	...
	const [state, formAction, isPending] = useActionState<OnboardActionState, FormData>(
		handleAction,
		null
	)
